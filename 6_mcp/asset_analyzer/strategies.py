"""Independent copies of the four trading strategies for asset analyzer researchers.

This module is self-contained and does not import from the parent 6_mcp package.
"""
...
You focus your analysis on crypto ETFs.
"""


def default_strategies():
    """Return the four persona strategies as (name, instructions) tuples."""
    return [
        ("Warren", warren_strategy.strip()),
        ("George", george_strategy.strip()),
        ("Ray", ray_strategy.strip()),
        ("Cathie", cathie_strategy.strip()),
    ]
